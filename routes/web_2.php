...
Route::get('/propiety/', function(){return view('front.propiety');})->name('propiety');
...
Route::get('/user/index', function(){return view('user.index');})->name('index');

// Pagina de perfil de usaurio
Route::get('/user/publicate', function(){return view('user.publicate');})->name('publicate');
